...
const SubHeader: React.FC<SubHeaderPropsType> = (props) => {
    return <div className="sub-header">
        ...
        <div className="sub-header-actions">
            ...
            {props.secondaryActionLabel?.length > 0 && <div className="action-button" onClick={props.secondaryAction}>
                <div className="sub-header-action-icon-container">
                    <img className="sub-header-action-icon" src={"/assets/icons/" + props.secondaryActionIcon}></img>
                </div>
